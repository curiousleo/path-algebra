...
Dijkstra's Algorithm, a single-source shortest path algorithm, may then be seen as computing one row of a solution to this equation.
...
Our correctness proof demonstrates that our algorithm does indeed compute the Right Local Solution to the fixpoint equation mentioned above, given a graph's adjacency matrix over a Sobrinho Algebra.
